...
BOSS_ROOM_PROFILES = [
    {
        ...
        "activation_delay": ENCOUNTER_WAVE_ACTIVATION_DELAY + 0.34,
        "attack_swap_delay": ENCOUNTER_ATTACK_SWAP_DELAY + 0.36,
        "pressure_lead_time": ENCOUNTER_PRESSURE_LEAD_TIME + 0.26,
        "spawn_stagger": 0,
        "entrance_offset": ENCOUNTER_ENTRANCE_OFFSET + 18,
        "entrance_move_speed": ENCOUNTER_ENTRANCE_MOVE_SPEED - 85,
        "entrance_pause": ENCOUNTER_ENTRANCE_PAUSE + 0.12,
        "flank_near_offset": ENEMY_FLANK_NEAR_OFFSET,
        "flank_far_offset": ENEMY_FLANK_FAR_OFFSET,
        "spacing_min_distance": ENEMY_SPACING_MIN_DISTANCE + 24,
        "recovery_text": "Punish Window",
    },
]
